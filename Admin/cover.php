<!DOCTYPE html>
<html>
<body style="background-image:url(images/doct4.jpg)">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="cal.png" width="30px" height="30px"><strong> DoctoMate </strong></a></li>
			...
			<div class="center">
				<h1>DoctoMate</h1><br>
				<p style="text-align:center;color:black;font-size:30px;top:35%">Better Doctor. Better Life.</p><br>
